...
#### ...usar AI tools (Copilot/Google AI)
→ [AI_TOOLS.md](./AI_TOOLS.md) + [AI_WORKFLOW.md](./AI_WORKFLOW.md)

#### ...aprender melhores práticas
→ [DEV_TOOLS.md](./DEV_TOOLS.md) + [SECURITY.md](./SECURITY.md)
...
3. **Abra uma [Issue no GitHub](https://github.com/marcusnerys/seven-os-platform/issues)**
...
- Segue **Clean Architecture** com **BLoC Pattern**
